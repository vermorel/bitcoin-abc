...
Once the source code is ready the build steps are below.
    ...
    CONFIG_SITE=$PWD/depends/x86_64-w64-mingw32/share/config.site ./configure --prefix=/ --prefix=/ --with-seeder=false # seeder not supported in Windows yet
    make
...
Then build using:
    ...
    cd ..
    ./autogen.sh # not required when building from tarball
    CONFIG_SITE=$PWD/depends/i686-w64-mingw32/share/config.site ./configure --prefix=/ --prefix=/ --with-seeder=false # seeder not supported in Windows yet
    make
